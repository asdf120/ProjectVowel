...
public class SearchIDView extends JFrame {
    ...
    public SearchIDView() {
        ...
        try{
            ...
            System.out.println("SearchIDView 접속실패 : " + e.toString());
        }
    ...
    public void doSearchID() {
        String tel = member_field[1].getText();
        try {
            String resultID = memberDao.searchId(tel);
            id_area.setText(resultID);
    ...
    // 입력한 값 초기화
    void clear() {
        member_field[0].setText(null);
        member_field[1].setText(null);
    }
}
