...
public class GuestControl extends HttpServlet {
	...
	private void initCommand(){
		...
		// 나머지도 추가하기
		commandMap.put("inputMessageForm",new CommandNull("insertMessage.jsp"));
		commandMap.put("inputMessageSave",new CommandInput("saveMessage.jsp"));
		commandMap.put("deleteMessage", new CommandNull("deleteMessage.jsp"));
		commandMap.put("deleteMessageOk", new CommandDelete("deleteConfirm.jsp"));
