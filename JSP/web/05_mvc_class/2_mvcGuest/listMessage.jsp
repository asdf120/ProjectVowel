...
<%
	...
	List <MessageVO> mList = (List)request.getAttribute("mList");
...
<body>
	...
	<a href="GuestControl?cmd=inputMessageForm">방명록 남기기 </a><br/><br/>
	...
	<table border="1">
		...
		<% for( MessageVO msg : mList ) { %>
		<tr>	
			<td> <%= msg.getId() %> </td> 
			<td> <%= msg.getGuestName() %></td> 
			<td> <a href="GuestControl?cmd=deleteMessage&messageId=<%=msg.getId()%>"> [ 삭제하기 ]</a> </td>
		</tr>
		<tr>
			<td colspan='3'> 
