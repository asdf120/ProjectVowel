create table member ( tel varchar2(20),
                password varchar2(15) not null,
                tel varchar2(13) not null,
                name varchar2(10) not null,
                birth varchar2(6) not null,
                email varchar2(50) not null,
            constraint pk_member_member_id primary key(tel));
...
create table reserve(reserve_no number,
        ...
        constraint fk_reserve_member_id foreign key(tel) references member(tel),
